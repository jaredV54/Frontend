...
const NavArea = () => {
  ...
  useEffect(() => {
    const fetchUserType = async () => {
      try {
        const response = await axios.post(`${config.Configuration.database}/userTypeAndStore`, values);
      ...
      <nav id='nav-container' className='nav-area close-nav-area'>
        ...
        (
          <ul className='nav-ul' onClick={handleRemoveClass}>
            ...
            <CustomLink to="/Home"><i className='bx bx-category' data-text="Products"></i></CustomLink>
