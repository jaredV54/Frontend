...
class Customer extends React.Component {
    ...
    render() {
        const { filteredCustomer, searchQuery, fName, lName, mName, address, email, contactNo, company, bDate,
        companyContactNo, contactPersonName, contactPersonNo, checkEmail, checkinput, option, selectedCustomer} = this.state;
        return (
            <div>
                      ...
                      <tbody className='table-body'>
                        {filteredCustomer.map((cust) => {
                          ...
                          return (
                            ...
                            >
                            {cust.id == JSON.parse(localStorage.getItem('selectedCustomer')).id ? (
